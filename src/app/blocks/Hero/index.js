      ...
      <section className="py-12">
        <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div className="flex-none space-y-5 px-4 pb-8  sm:max-w-lg md:px-0 lg:max-w-xl">
            ...
            <p>
              ...
              Desfrute de momentos únicos com sua família e amigos, em um
              ambiente acolhedor e totalmente equipado. Reserve agora e comece a
              planejar sua experiência memorável.
            </p>
        ...
        <div className="mt-14 px-4 md:px-8 pb-8">
          ...
          <div className="flex justify-center items-center flex-wrap gap-x-12 gap-y-6 mt-4">
            <img
              className="h-14"
              src="/midias/brands/airbnb.svg"
              alt="airbnb"
            />
            <img
              className="h-10 mt-2"
              src="/midias/brands/booking.svg"
              alt="booking"
            />
          </div>
        </div>
