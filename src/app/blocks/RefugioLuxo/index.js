...
export default function RefugioLuxo() {
  return (
        ...
        <section className='know flex bg-primary items-center justify-center min-h-screen bg-teal-100 lg:text-center py-24 px-8'> 
<div className='container max-w-7xl justify-center flex flex-col items-center  '>
      <div className='w-full justify-center '> 
          <h2 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">Um Refúgio de Luxo na Praia do Patacho</h2>
          <p className="mb-6 xs:text-xs font-normal text-gray-500 lg:text-xl ">Descubra o charme único de nossas casas boutique, onde o conforto cinco estrelas encontra o toque artesanal e elegante. </p>
