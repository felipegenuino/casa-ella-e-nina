...
<div class="relative rounded-xl overflow-auto">
  <div class="max-full mx-auto bg-white shadow-xl min-w-0 dark:bg-slate-800 dark:highlight-white/5">
  <div class="overflow-x-auto flex">
    <div class="flex-none py-6 px-3 first:pl-6 last:pr-6">
      <div class="flex flex-col items-center justify-center gap-3">
        ...
        <strong class="text-slate-900 text-xs font-medium dark:text-slate-200"><font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>André</font></font></strong>
      </div>
    </div> 
    <div class="flex-none py-6 px-3 first:pl-6 last:pr-6">
      <div class="flex flex-col items-center justify-center gap-3">
